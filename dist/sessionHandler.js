...
exports.getValidSession = void 0;
const fs_1 = __importDefault(require("fs"));
const path_1 = __importDefault(require("path"));
const mojang_1 = __importDefault(require("mojang"));
function buildPath(email) {
    const folderPath = path_1.default.join(__dirname, '../sessions/');
    if (!fs_1.default.existsSync(folderPath)) {
        fs_1.default.mkdirSync(folderPath);
    }
    return path_1.default.join(folderPath, `session-${email.toLowerCase()}.json`);
}
